...
; Create zip files
; »—ѕ–ј¬Ћ≈Ќ»≈ 2: »зменен путь исходников. »—ѕ–ј¬Ћ≈Ќ»≈ 3: Ќазвание архива hakchi3
...
; ¬Ќ»ћјЌ»≈: ≈сли ты мигрировал утилиту Zipper на .NET 8, помен¤й в строке выше net48 на net8.0-windows

; The icon of the installer
Icon "..\hakchi_gui\icon_app.ico"

; The file to write
; »—ѕ–ј¬Ћ≈Ќ»≈ 4: ѕереименовано в hakchi3
...
; »—ѕ–ј¬Ћ≈Ќ»≈ 5: »м¤ инсталл¤тора
Name "Hakchi3 ${DisplayVersion}"

; Registry key to check for directory
; »—ѕ–ј¬Ћ≈Ќ»≈ 6: —менил ветку реестра, чтобы Hakchi3 не конфликтовал с Hakchi2 CE на ѕ  пользовател¤
...
Section "Hakchi3 ${DisplayVersion} (required)" section_main
  SectionIn RO
  SetOutPath $INSTDIR
  ; »—ѕ–ј¬Ћ≈Ќ»≈ 7: Ѕерем файлы дл¤ инсталл¤тора из новой папки .NET 8
...
Section "Uninstall"
  ...
  ; »—ѕ–ј¬Ћ≈Ќ»≈ 8: ѕодключаем файл, который реально генерирует vcxproj в релизе
...
Function .onSelChange
  ${If} ${SectionIsSelected} ${section_portable}
    ; »—ѕ–ј¬Ћ≈Ќ»≈ 9: ќбновлено название папки портативной версии
